...
tag              | Description
----------------|-------------------------------------------------------------------
26.07.18.01 | This is the latest versions as noted below. Available for x86_64 and arm64.
...
----------|----------|-|----------|---------
| gvmd | v26.34.0 | | gvm_libs | v23.9.1 |
| openvas | v23.50.2 | | openvas_smb | v22.5.10 |
| notus_scanner | v22.7.2 | | gsa | v27.5.0 |
| gsad | v26.5.0 | | ospd | v21.4.4 |
| ospd_openvas | v22.10.4 | | pg_gvm | v22.6.18 |
| python_gvm | v27.5.0 | | gvm_tools | v26.0.7 |
| greenbone_feed_sync | v25.4.1 |

# 25 August 2023 #
## Discussions!!! ##

Moving forward, all new versions and any other changes will be posted in the [Announcements](https://github.com/immauss/openvas/discussions). The contents of this Readme will be preserved as [OldReadme.md](https://github.com/immauss/openvas/blob/master/OldReadme.md). 
